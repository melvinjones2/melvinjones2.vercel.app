...
function Skills({ skills }: Props) {
  return (
    ...
    >
      <h3 className="absolute top-16 uppercase tracking-[20px] text-gray-500 text-2xl md:text-3xl">
        Skills
      </h3>
      ...
      <div className="pt-8 grid grid-cols-4 gap-3 md:gap-5 mt-3 sm:mt-15 justify-center">
